...
<body>
    ...
    echo "<h2>En este ejemplo se utuliza la funcion include() que ubica codigo php definido en el archivo ejemplo.inc</h2>" ;
    ...
    echo "<h2> Aqui ya se ejecuto la funcion include(). Cuando se usa include ocurre que si el archivo 'inc' no existe,
